<br>
<div align='center'>
	<h1>Hello world Back-end (API)</h1>
  </div>
<a name="readme-top"></a>
...
- This project serves as a basic example of how to set up a Ruby on Rails API, interact with a PostgreSQL database, and provide dynamic content through API endpoints.
...
`git clone https://github.com/jicamargo/helloworld_backend.git`
...
5. Open your web browser and navigate to: http://localhost:3000/api/random_greeting/ to access the application. 

6. **Front End**: If you would like to see the front-end of this project, please visit the [hello_world_frontend](https://github.com/jicamargo/helloworld_frondend) repository and follow the instructions in the README.md file.
...
Feel free to check the [issues page](https://github.com/jicamargo/helloworld_backend/issues).
